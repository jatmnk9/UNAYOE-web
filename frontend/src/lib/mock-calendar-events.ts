import { CalendarEvent } from '@/pages/citas/components/calendar/calendar-types'
import { addDays, startOfMonth } from 'date-fns'
import { colorOptions } from '@/pages/citas/components/calendar/calendar-tailwind-classes'
